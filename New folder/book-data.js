...
class UI {
  //display books
    ...
    static addBookToList(book){
        ...
        row.innerHTML = `<td>${book.title}</td> <td>${book.author}</td> <td>${book.language}</td> <td>${book.subject}</td>`;
...
// Store new books and stores old books
class Store {
    static getBooks() {
      let books;
